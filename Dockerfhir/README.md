...
This repository contains Docker resources for running **Kong with FHIR**.  

## Updates
- **Lesson 35 – FHIR API Management**  
  A new **Kong container** has been added to demonstrate API management for FHIR.  
- A **Swagger UI container** is included to show how to expose FHIR APIs using **OpenAPI 3.0**.  

## Components
- **Kong API Gateway** – Provides traffic management, security, and observability for FHIR APIs.  
- **FHIR Server** – Backend service exposing FHIR resources.  
- **Swagger UI** – Interactive API documentation for FHIR endpoints using OpenAPI 3.0.  
...
FHIR Server: http://localhost:<fhir-port>

Swagger UI: http://localhost:<swagger-port>
